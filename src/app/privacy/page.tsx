...
export default function PrivacyPolicy() {
  return (
    <Wrap title="Privacy Policy" crumb="Privacy Policy">
      <div className="max-w-3xl space-y-12">
        <Reveal>
          <p className="serif-h text-[24px] lg:text-[32px] text-ink leading-[1.4]">
            We collect the minimum information required to deliver your orders and improve your experience. We never sell your data to third parties. Read below for full details on collection, cookies, and your rights.
          </p>
        </Reveal>
