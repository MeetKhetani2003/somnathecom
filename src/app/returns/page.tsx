...
export default function ReturnsPolicy() {
  return (
    <Wrap title="Returns & Exchanges" crumb="Returns & Exchanges">
      <div className="max-w-3xl space-y-12">
        <Reveal>
          <p className="serif-h text-[24px] lg:text-[32px] text-ink leading-[1.4]">
            We offer a seven-day return and exchange window from the date of delivery. Pieces must be in their original condition — unworn, unwashed, with all tags. Reverse pickup is complimentary.
          </p>
        </Reveal>
