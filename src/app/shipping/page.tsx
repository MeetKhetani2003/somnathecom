...
export default function ShippingPolicy() {
  return (
    <Wrap title="Shipping Policy" crumb="Shipping Policy">
      <div className="max-w-3xl space-y-12">
        <Reveal>
          <p className="serif-h text-[24px] lg:text-[32px] text-ink leading-[1.4]">
            Complimentary shipping on orders above ₹999. Standard delivery takes 2–4 days for metros and 3–6 days pan-India. Cash on Delivery is available across most pincodes.
          </p>
        </Reveal>
